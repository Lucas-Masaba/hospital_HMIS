...
RSpec.describe Visit, type: :model do
  subject do
    Patient.new(name: 'Kemigisa Diana', age: 12, gender: 'F', date_of_birth: '2023-01-23',
    ...
    Visit.new(visit_no: '2', visit_owner: 'Caitylyn', visit_date: '2023-01-23', visit_type: 'review',
              visit_category: 'insurance', speciality: 'cardiology', member_no: '2A5R2', service: 'Treatment', patient_id: '1')
  end
